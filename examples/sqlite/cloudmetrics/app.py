"""
CloudMetrics Data Agent — SQLite CLI application using AskMeDB.

A natural language data agent for querying SaaS business data via SQLite.

Usage:
    1. Generate data: python examples/setup_db.py
    2. Set your API key: export ANTHROPIC_API_KEY=...
    3. Run: python examples/sqlite/cloudmetrics/app.py
"""
...
def print_help():
    ...
    console.print(
        Panel(
            "[bold]CloudMetrics Data Agent (SQLite)[/bold]\n\n"
...
def main():
    console.print(
        Panel.fit(
            "[bold blue]CloudMetrics Data Agent (SQLite)[/bold blue]\n"
